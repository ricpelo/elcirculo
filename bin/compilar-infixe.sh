...
inform-infixe -E1 -D -X $* \$MAX_OBJ_PROP_COUNT=100 \$MAX_LABELS=2000 +language_name=Spanish +include_path=,lib,INFSP6,InformLibrary611,Alpha_pack,Alpha_pack/ZIPI_NG,Damusix elcirculo.inf
